...
protected:
   ...
   virtual orientation_t get_orientation() const noexcept = 0;

   //! Gets piece data
   virtual void get_shape_data(shapedata_t & data) const noexcept = 0;
