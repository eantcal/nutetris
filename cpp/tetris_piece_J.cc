...
//! The "J" piece of the tetris game
class piece_J_t : public concrete_piece_t
{
public:
   piece_J_t(col_t c = get_next_piece_index()) : concrete_piece_t(c)
   {
      assert(c > 0);

      {
         const row_t r1 = { 0, 0, 0, 0 };
         const row_t r2 = { 0, c, c, c };
