...
//! The "O" piece of the tetris game
class piece_O_t : public concrete_piece_t
{
public:
   piece_O_t(col_t c = get_next_piece_index()) : concrete_piece_t(c)
   {
      assert(c > 0);
