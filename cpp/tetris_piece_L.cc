...
//! The "L" piece of the tetris game
class piece_L_t : public concrete_piece_t
{
public:
   piece_L_t(col_t c = get_next_piece_index()) : concrete_piece_t(c)
   {
      assert(c > 0);
